...
import { Activity, Users, LucideIcon } from 'lucide-react';
...
export default function TopAuthors({ data }: TopAuthorsProps) {
    if (!data) return (
            ...
            <Card title="Top Contributors" icon={Users}>
                <div className="overflow-auto pr-2 h-full">
                    <div className="space-y-4">
                        {data.topContributors && data.topContributors.map((author: any, index: number) => (
